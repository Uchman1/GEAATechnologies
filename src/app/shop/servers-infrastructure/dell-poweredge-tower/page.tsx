...
const product = products.find((p) => p.slug === "dell-poweredge-tower")!;
const category = shopCategories.find((c) => c.slug === "servers-infrastructure")!;

export const metadata: Metadata = buildMetadata({
  title: `${product.name} | ${category.name}`,
  description: product.shortDescription,
  path: "/shop/servers-infrastructure/dell-poweredge-tower",
});

export default function DellPoweredgeTowerPage() {
