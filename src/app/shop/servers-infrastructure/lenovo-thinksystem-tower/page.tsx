...
const product = products.find((p) => p.slug === "lenovo-thinksystem-tower")!;
const category = shopCategories.find((c) => c.slug === "servers-infrastructure")!;

export const metadata: Metadata = buildMetadata({
  title: `${product.name} | ${category.name}`,
  description: product.shortDescription,
  path: "/shop/servers-infrastructure/lenovo-thinksystem-tower",
});

export default function LenovoThinksystemTowerPage() {
