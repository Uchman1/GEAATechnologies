...
const product = products.find((p) => p.slug === "hpe-proliant-tower")!;
const category = shopCategories.find((c) => c.slug === "servers-infrastructure")!;

export const metadata: Metadata = buildMetadata({
  title: `${product.name} | ${category.name}`,
  description: product.shortDescription,
  path: "/shop/servers-infrastructure/hpe-proliant-tower",
});

export default function HpeProliantTowerPage() {
