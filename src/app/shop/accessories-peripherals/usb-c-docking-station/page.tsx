...
const product = products.find((p) => p.slug === "usb-c-docking-station")!;
const category = shopCategories.find((c) => c.slug === "accessories-peripherals")!;

export const metadata: Metadata = buildMetadata({
  title: `${product.name} | ${category.name}`,
  description: product.shortDescription,
  path: "/shop/accessories-peripherals/usb-c-docking-station",
});

export default function UsbCDockingStationPage() {
