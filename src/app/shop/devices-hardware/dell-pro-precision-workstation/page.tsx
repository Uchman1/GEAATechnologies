...
const product = products.find((p) => p.slug === "dell-pro-precision-workstation")!;
const category = shopCategories.find((c) => c.slug === "devices-hardware")!;

export const metadata: Metadata = buildMetadata({
  title: `${product.name} | ${category.name}`,
  description: product.shortDescription,
  path: "/shop/devices-hardware/dell-pro-precision-workstation",
});

export default function DellProPrecisionWorkstationPage() {
